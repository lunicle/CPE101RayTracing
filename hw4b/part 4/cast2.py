...
def cast_ray(ray, sphere_list, ambient_color,light):
    ...
    if result == []:
        ...
        near_sphere = nearest_sphere(ray,sphere_list)
        ...
        diffuse_factor = diffuse_factor1(sphere_list,N,light_dir,near_sphere,P_epsilon)
...
def diffuse_factor1(sphere_list,N, light_dir,near_sphere,P_epsilon):
