...
class Sphere():
    def __init__(self,point,radius,color):
        ...
        self.color = color
    def __eq__(self, other):
        return utility.epsilon_equal(self.point, other.point) and utility.epsilon_equal(self.radius, other.radius) and utility.epsilon_equal(self.color,other.color)
